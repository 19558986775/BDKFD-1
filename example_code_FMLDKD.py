...
parser.add_argument('--dataset', type=str,
                    default='mnist', help='change to CIFAR10 or CIFAR100')

parser.add_argument('--n_client', type=int,
                    default=100, help='the number of client')

parser.add_argument('--seed', type=int,
                    default=30, help='change to 20 while the rule is Drichlet')
...
parser.add_argument('--model_name', type=str,
                    default='mnist_2NN', help='mnist_2NN or cifar100_LeNet or cifar10_LeNet')

# the setting of training
parser.add_argument('--com_amount', type=int,
                    default=2, help='mnist:600, cifar10 and cifar100:1000')
...
parser.add_argument('--alpha_coef', type=float, default=1e-2, help='dyn and dc, mnist in DC: 0.1')

parser.add_argument('--baselines', type=str, default='FedAvg_FMLDKD',
                    help='FedAvg_FMLDKD or FedProx_FMLDKD or FedDyn_FMLDKD or FedDC_FMLDKD')

opt = parser.parse_args()


# Dataset
data_obj = DatasetObject(dataset=opt.dataset, n_client=opt.n_client, seed=20, rule=opt.rule, rule_arg=opt.rule_arg,
